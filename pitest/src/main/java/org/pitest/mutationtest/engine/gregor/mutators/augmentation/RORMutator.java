...
public class RORMutator implements MethodMutatorFactory {
   ...
   */
  public RORMutator(final OpcodeCompareToZero operator) {
...
class RelationalOperatorReplacementIFEQMethodVisitor extends AbstractJumpMutator {
  ...
  private static final RORMutator.OpcodeCompareToZero REPLACEMENT_ZERO_OP
      = RORMutator.OpcodeCompareToZero.IFEQ;
  private static final RORMutator.OpcodeCompare REPLACEMENT_COMP_OP
      = RORMutator.OpcodeCompare.IF_ICMPEQ;

  static {
    // The operands will seem to be in the wrong order when used in
    // else conditions.  To the bytecode parser, though, this is not
    // the case.
    for (RORMutator.OpcodeCompareToZero original
           : RORMutator.OpcodeCompareToZero.values()) {
    ...
    for (RORMutator.OpcodeCompare original
           : RORMutator.OpcodeCompare.values()) {
...
class RelationalOperatorReplacementIFGEMethodVisitor extends AbstractJumpMutator {
  private static final Map<Integer, Substitution> MUTATIONS = new HashMap<>();
  private static final RORMutator.OpcodeCompareToZero REPLACEMENT_ZERO_OP
      = RORMutator.OpcodeCompareToZero.IFGE;
  private static final RORMutator.OpcodeCompare REPLACEMENT_COMP_OP
      = RORMutator.OpcodeCompare.IF_ICMPGE;
...
class RelationalOperatorReplacementIFGTMethodVisitor extends AbstractJumpMutator {
  private static final Map<Integer, Substitution> MUTATIONS = new HashMap<>();
  private static final RORMutator.OpcodeCompareToZero REPLACEMENT_ZERO_OP
      = RORMutator.OpcodeCompareToZero.IFGT;
  private static final RORMutator.OpcodeCompare REPLACEMENT_COMP_OP
      = RORMutator.OpcodeCompare.IF_ICMPGT;
...
class RelationalOperatorReplacementIFLEMethodVisitor extends AbstractJumpMutator {
  private static final Map<Integer, Substitution> MUTATIONS = new HashMap<>();
  private static final RORMutator.OpcodeCompareToZero REPLACEMENT_ZERO_OP
      = RORMutator.OpcodeCompareToZero.IFLE;
  private static final RORMutator.OpcodeCompare REPLACEMENT_COMP_OP
      = RORMutator.OpcodeCompare.IF_ICMPLE;
...
class RelationalOperatorReplacementIFLTMethodVisitor extends AbstractJumpMutator {
  private static final Map<Integer, Substitution> MUTATIONS = new HashMap<>();
  private static final RORMutator.OpcodeCompareToZero REPLACEMENT_ZERO_OP
      = RORMutator.OpcodeCompareToZero.IFLT;
  private static final RORMutator.OpcodeCompare REPLACEMENT_COMP_OP
      = RORMutator.OpcodeCompare.IF_ICMPLT;
...
class RelationalOperatorReplacementIFNEMethodVisitor extends AbstractJumpMutator {
  ...
  private static final RORMutator.OpcodeCompare REPLACEMENT_COMP_OP
      = RORMutator.OpcodeCompare.IF_ICMPNE;
