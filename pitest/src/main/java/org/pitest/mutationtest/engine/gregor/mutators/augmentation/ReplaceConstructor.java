 ...
 *
 */
enum ReplaceConstructorMutator implements MethodMutatorFactory {
	;
...
class ReplaceConstructor extends AbstractInsnMutator {
	...
	public ReplaceConstructor(final MethodMutatorFactory factory, MethodInfo methodInfo, final MutationContext context,
