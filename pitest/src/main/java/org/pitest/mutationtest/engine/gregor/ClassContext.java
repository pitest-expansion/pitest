...
class ClassContext implements BlockCounter {
    ...
    /**
     * Get the fully qualified name of a class, then replace "/" with "." so it can
     * be written to the bytecode. It's very helpful for constructing the owner and
     * class name for GETFIELD, PUTFIELD, INVOKE...
     * 
     * @return fully qualified class name with "/" instead of "."
     */
    ...
    private static Predicate<MutationIdentifier> idMatches(final MutationIdentifier newId) {
