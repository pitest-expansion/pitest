...
import org.pitest.mutationtest.engine.gregor.mutators.augmentation.ScanForOverloadingMethod;

import bsh.org.objectweb.asm.ClassVisitor;
import bsh.org.objectweb.asm.CodeVisitor;

public enum ReplaceWithOverloadingMethodMutator implements MethodMutatorFactory {
...
class ReplaceWithOverloadingMethod extends AbstractInsnMutator {
	...
	public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
		...
		if (opcode == Opcodes.INVOKEVIRTUAL || opcode == Opcodes.INVOKESTATIC) {
			...
			if (this.context.shouldMutate(muID)) {
				...
				this.replaceMethodDescriptor(opcode, owner, name, desc, itf);
	...
	/**
	 * return a byte[] for from the Optional object.
	 * 
	 * @return
	 */
	 ...
	 */
	private void replaceMethodDescriptor(int opcode, String owner, String name, String desc, boolean itf) {
